{
  ...
  outputs =
    ...
    let
      ...
      # this value across the five manifests that carry a Rust pin:
      #   - flake.nix                          (this file)
      ...
      # The same check also reads package.json for the pnpm pin, and
      # mise.toml and .github/workflows/ci.yml for the Node.js major.
      rustVersion = "1.95.0";
